...
namespace model_base_logit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_base_logit");
    reader.add_event(41, 39, "end", "model_base_logit");
    return reader;
}
#include <stan_meta_header.hpp>
class model_base_logit : public prob_grad {
private:
        int U;
        int N;
        double scale_u;
        ...
        std::vector<int> y;
public:
    model_base_logit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_base_logit_namespace::model_base_logit";
        ...
        try {
            ...
            validate_non_negative_index("X", "U", U);
            context__.validate_dims("data initialization", "X", "matrix_d", context__.to_vec(N,U));
            X = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(N, U);
            vals_r__ = context__.vals_r("X");
            pos__ = 0;
            size_t X_j_2_max__ = U;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(mu,multiply(X, beta_u));
            current_statement_begin__ = 35;
            lp_accum__.add(normal_log<propto__>(beta_u, 0, scale_u));
            current_statement_begin__ = 38;
            lp_accum__.add(bernoulli_logit_log<propto__>(y, mu));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_base_logit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_base_logit_namespace::model_base_logit stan_model;
#endif
