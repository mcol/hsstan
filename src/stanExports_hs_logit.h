...
namespace model_hs_logit_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_hs_logit");
    ...
    reader.add_event(44, 11, "restart", "model_hs_logit");
    reader.add_event(134, 99, "end", "model_hs_logit");
    return reader;
}
...
class model_hs_logit : public prob_grad {
private:
        int P;
        int U;
        int N;
        ...
        double slab_df;
public:
    model_hs_logit(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_hs_logit_namespace::model_hs_logit";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(regularized)) {
                ...
                stan::math::assign(beta_p, reg_hs(z, r1_local, r2_local, r1_global, r2_global, global_scale, (slab_scale * c2), pstream__));
            } else {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_hs_logit_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_hs_logit_namespace::model_hs_logit stan_model;
#endif
