...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(47, 45, "end", "model_base");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(mu,multiply(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_min_max(1, U), stan::model::nil_index_list())), "X"), beta_u));
